...
function saveProduct() {
    ...
    if (editIndex !== "") {
        ...
        products[category][editIndex] = { name, price, img };
    } else {
        // Add new product
        products[category].push({ name, price, img });
    }
...
// Create admin user automatically if not created
if (!localStorage.getItem("adminUser")) {
    const admin = {
        email: "admin@acidic.com",
