...
function validateCheckoutForm() {
    ...
    if (isValid) {
        ...
        console.log('✅ Checkout data saved, redirecting to PayFast page...');
        
        // Close checkout modal
        closeCheckout();
        
        // REDIRECT TO STANDALONE PAYFAST PAGE (bypasses all interference)
        window.location.href = 'payfast-checkout.html';
    }
